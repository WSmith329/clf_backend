...
from common.utils.youtube import convert_to_embed
...
class AbstractActivity(models.Model):
    ...
    slug = AutoSlugField(unique=True, max_length=50, populate_from='name')
...
class Exercise(AbstractActivity):
    ...
    def save(self, *args, **kwargs):
        self.video_url = convert_to_embed(self.video_url)
        super().save(*args, **kwargs)
